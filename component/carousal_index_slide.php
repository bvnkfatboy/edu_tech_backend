                ...
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-3">
                    ...
                    <div class="p-5 ">
                        <div class="mb-3 flex flex-wrap justify-between">
                            ...
                            <p class=" text-xs text-gray-700 dark:text-gray-400">แหล่งที่มา: <?php echo $row['img_source']; ?></p>
            ...
            <form class="p-4 md:p-5 carousal-create-body" action="" method="post" enctype="multipart/form-data">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2" id="option-image">
                        <label for="option-image-category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">แหล่งที่มา</label>
                    ...
                    <div class="col-span-2" id="option-image-1">
                        <label for="imageweb" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ลิ้งก์แหล่งที่มา</label>
