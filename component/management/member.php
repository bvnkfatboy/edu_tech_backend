            ...
            <tbody>
               ...
               while($row = mysqli_fetch_array($result)){
                  ...
                  <tr class="bg-white border-b light:bg-gray-800 light:border-gray-700 hover:bg-gray-50 light:hover:bg-gray-600">
                     ...
                     <td class="px-6 py-4">
                        <button data-modal-target="modal-edit" data-modal-toggle="modal-edit" class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 light:bg-green-600 light:hover:bg-green-700 light:focus:ring-green-800" type="button">
                        แก้ไขข้อมูล
                        </button>
                     </td>
                  </tr>
...
<!-- Main modal -->
<div id="modal-edit" tabindex="10" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow light:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t light:border-gray-600">
                ...
                <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center light:hover:bg-gray-600 light:hover:text-white" data-modal-hide="modal-edit">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="" method="post">
                    ...
                    <button type="submit" name="auth" value="create" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800">แก้ไขข้อมูล</button>
                </form>
            </div>
        </div>
    </div>
