...
<div class="flex justify-center h-100 w-100 p-4 sm:ml-64 items-center">
    <div class="p-4  mt-14">
        <div class="w-[370px] h-[525px] relative">
            ...
            <div class="w-[370px] left-0 top-[255px] absolute text-black text-xl font-normal font-['Kanit'] yorna">เขียนด้วยภาษา PHP แบบ “Single Page Application (SPA)” หรือ หน้าเว็บเดียว โดยใช้ index.php เป็นหน้าหลัก และใช้ switch case หรือ if-else เพื่อตรวจสอบค่า GET parameter เพื่อให้แสดงหน้าที่ถูกต้องโดยใช้ require_once เพื่อเรียกไฟล์ component<br/><br/>โดยส่วนเสริม (framework) ใช้ tailwind css,flowbite (tailwind custom),Ajax</div>
        </div>
    </div>
</div>
