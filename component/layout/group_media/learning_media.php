...
if (isset($_POST['learning_media']) && $_POST['learning_media'] == "create") {
    ...
    if ($option == 'PC') {
        ...
        if (isset($_FILES['imagepc']) && $_FILES['imagepc']['error'] === UPLOAD_ERR_OK) {
            ...
            if (in_array($file_extension, $allowed_types)) {
                ...
                if (move_uploaded_file($_FILES['imagepc']['tmp_name'], $upload_file)) {
                    ...
                    $insert_sql = "INSERT INTO learning_media (media_title , img_resource, img_source,media_link, media_date,img_location,media_type) 
        ...
        $insert_sql = "INSERT INTO learning_media (media_title , img_resource, img_source,media_link, media_date,media_type) 
...
if (isset($_GET['delete_img'])) {
    ...
    $sql = "SELECT * FROM `learning_media` WHERE `media_id` = $deleteImgId";
    ...
    if ($imgRow && isset($imgRow['media_id']) && $imgRow['media_id'] == $deleteImgId) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = '?page=delete&&deletetype=learning_media&&confirm_delete=$deleteImgId';
            }
        });
    </script>";
    }
...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg light:border-gray-700 mt-14">
        ...
        <div class="flex flex-wrap py-5 ">
            <?php $sql = "SELECT * FROM `learning_media`";
            $result = $connection->query($sql); ?>
