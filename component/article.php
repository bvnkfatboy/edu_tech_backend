        ...
        if (isset($_FILES['imagepc']) && $_FILES['imagepc']['error'] === UPLOAD_ERR_OK) {
            ...
            if (in_array($file_extension, $allowed_types)) {
                ...
                if (move_uploaded_file($_FILES['imagepc']['tmp_name'], $upload_file)) {
                    ...
                    $insert_sql = "INSERT INTO article (article_title , img_resource, img_source,article_link, article_update,img_location) 
                    VALUES ('$articletitle','$upload_url', 'คอมพิวเตอร์','$articlelink', NOW(),'$upload_file')";
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5 article-create-body" action="" method="post" enctype="multipart/form-data">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2" >
                        <label for="articlelink" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ลิ้งก์เชื่อมโยงไปยังบทความ</label>
                        <input type="text" name="articlelink" id="articlelink" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" value="#">
                        <label  class="hidden mt-5 flex flex-col items-center justify-center w-full  border-2 border-gray-300 border-dashed rounded-lg  bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6"></div>
                        </label>
                    </div>
